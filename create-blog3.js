...
const payload = {
  fields: {
    ...
    excerpt: { stringValue: 'Discover the science of pleasure, ergonomic designs, and how Funtroo premium collection can revolutionize your solo or couples wellness journey.' },
...
const req = https.request('https://firestore.googleapis.com/v1/projects/funtrooo/databases/(default)/documents/blogs', options, (res) => {
  let data = '';
