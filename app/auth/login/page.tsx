        ...
        <div className="bg-f-grayBg border border-f-border rounded-2xl p-7 shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="relative">
              ...
              <div className="relative">
                <input type={showPass ? "text" : "password"} value={form.password}
                  ...
                  className="w-full bg-f-dark border border-f-border rounded-xl px-3 py-2.5 text-sm text-f-light outline-none focus:border-f-accent placeholder:text-f-muted transition pr-10"
                  required placeholder="••••••••" />
                <button type="button" onClick={() => setShowPass(!showPass)} className="absolute right-3 top-1/2 -translate-y-1/2 text-f-muted hover:text-f-accent transition">
            ...
            <button type="submit" disabled={loading}
              className="w-full py-3 bg-f-purple text-white rounded-xl text-sm font-medium hover:bg-f-mid shadow-lg shadow-f-purple/20 transition disabled:opacity-60 mt-2">
